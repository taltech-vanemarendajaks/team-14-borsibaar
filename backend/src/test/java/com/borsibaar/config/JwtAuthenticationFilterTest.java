...
class JwtAuthenticationFilterTest {
    ...
    void testFilter_WithInvalidJwtCookie_DoesNotAuthenticate() throws Exception {
        ...
        // Act & Assert: Request with invalid JWT should return 401 Unauthorized (401)
        // Spring Security intercepts unauthenticated API requests
        mockMvc.perform(get("/api/users")
    ...
    void testFilter_WithoutJwtCookie_DoesNotAuthenticate() throws Exception {
        // Act & Assert: Request without JWT cookie should return 401 Unauthorized
        // (401)
        mockMvc.perform(get("/api/users"))
                .andExpect(status().isUnauthorized());
    }
    ...
    void testFilter_WithExpiredToken_DoesNotAuthenticate() throws Exception {
        ...
        // Act & Assert: Request with expired/invalid token should return 401 (401)
        mockMvc.perform(get("/api/users")
    ...
    void testFilter_WithEmptyJwtCookie_DoesNotAuthenticate() throws Exception {
        // Act & Assert: Request with empty JWT cookie should return 401 (401)
        mockMvc.perform(get("/api/users")
